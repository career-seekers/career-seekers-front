...
export enum FileType {
  ...
  TOTAL_PARTICIPANTS_QUALIFYING = "TOTAL_PARTICIPANTS_QUALIFYING",
  TOTAL_PARTICIPANTS_FINAL = "TOTAL_PARTICIPANTS_FINAL",
  REGISTRATION_LIST_QUALIFYING = "REGISTRATION_LIST_QUALIFYING",
  REGISTRATION_LIST_FINAL = "REGISTRATION_LIST_FINAL",
  REGISTRATION_LIST_STUDYING = "REGISTRATION_LIST_STUDYING",
}
