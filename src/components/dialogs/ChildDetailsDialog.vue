      ...
      <div class="details-section">
        <div class="section-header">
          ...
          <Button
            ...
            @click="deleteChild(childDetails.child.id)"
          />
        </div>
        <div class="details-grid">
          <div class="detail-item">
            ...
            <span class="detail-value">
              {{ `${childDetails.child.lastName} ${childDetails.child.firstName} ${childDetails.child.patronymic}` }}
            </span>
          </div>
          <div class="detail-item">
            <span class="detail-label">Возрастная группа:</span>
            <span class="detail-value">
              {{ useAgeGroups.find(group => group.value === childDetails?.child.childDocuments?.ageCategory)?.label }}
            </span>
          </div>
          <div class="detail-item">
