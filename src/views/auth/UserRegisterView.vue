          ...
          >
            <h3 class="step-title">
              ...
              >ФИО *</label>              <InputText
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.fullName }"
              />              <small
                v-if="parentFormErrors.fullName"
                class="p-error"
              >{{ parentFormErrors.fullName }}</small>
            </div>            <div class="field">
              <label
                for="birthDate"
                class="field-label"
