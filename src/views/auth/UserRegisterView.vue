          ...
          >
            <h3 class="step-title">
              ...
              >Фамилия *</label>              <InputText
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.lastName }"
              />              <small
                v-if="parentFormErrors.lastName"
                class="p-error"
              >{{ parentFormErrors.lastName }}</small>
            </div>            <div class="field">
              <label
                for="firstName"
                class="field-label"
              >Имя *</label>              <InputText
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.firstName }"
              />              <small
                v-if="parentFormErrors.firstName"
                class="p-error"
              >{{ parentFormErrors.firstName }}</small>
            </div>            <div class="field">
              <label
                for="patronymic"
                class="field-label"
              ...
              >Дата рождения *</label>              <InputMask
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.birthDate }"
              />              <small
                v-if="parentFormErrors.birthDate"
                class="p-error"
              >{{ parentFormErrors.birthDate }}</small>
            </div>            <div class="field">
              <label
                for="relationship"
                class="field-label"
              >Кем приходится? *</label>              <InputText
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.relationship }"
              />              <small
                v-if="parentFormErrors.relationship"
                class="p-error"
              >{{ parentFormErrors.relationship }}</small>
            </div>            <div class="field">
              <label
                for="telegramLink"
                class="field-label"
              >Ссылка на Telegram *</label>              <InputText
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.telegramLink }"
                @blur="validateTelegramLink"
              />              <small
                v-if="parentFormErrors.telegramLink"
                class="p-error"
              >{{ parentFormErrors.telegramLink }}</small>
            </div>            <div class="field">
              <label
                for="phone"
                class="field-label"
              >Контактный телефон *</label>              <InputMask
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.phone }"
              />              <small
                v-if="parentFormErrors.phone"
                class="p-error"
              >{{ parentFormErrors.phone }}</small>
            </div>            <div class="field">
              <label
                for="email"
                class="field-label"
              >Адрес электронной почты *</label>              <InputText
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.email }"
                @blur="validateEmail"
              />              <small
                v-if="parentFormErrors.email"
                class="p-error"
              >{{ parentFormErrors.email }}</small>
            </div>            <div class="field">
              <label
                for="password"
                class="field-label"
              >Пароль *</label>              <Password
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.password }"
                :feedback="true"
                toggle-mask
                weak-label="Слабый"
...
strong-label="Надежный" prompt-label="Введите пароль" @blur="validatePassword"
              />              <small
                ...
                class="p-error"
              >{{ parentFormErrors.password }}</small>
            </div>            <div class="field">
              <label
                for="confirmPassword"
                class="field-label"
              >Подтверждение пароля *</label>              <Password
                ...
                class="w-full"
                :class="{ 'p-invalid': parentFormErrors.confirmPassword }"
                :feedback="false"
                toggle-mask
              />              <small
                v-if="parentFormErrors.confirmPassword"
                class="p-error"
              >{{ parentFormErrors.confirmPassword }}</small>
            </div>            <div class="field">
              ...
              <div class="flex align-items-center">
                <Checkbox
                  ...
                  input-id="consent"
                  :binary="true"
                  :class="{ 'p-invalid': parentFormErrors.consent }"
                />                <label
                  for="consent"
                  class="ml-2 agreement-label"
                >                  Я согласен(-а) на                  <a
                ...
                v-if="parentFormErrors.consent"
                class="p-error"
              >{{ parentFormErrors.consent }}</small>
            </div>            <div class="field">
              <div class="flex align-items-center">
                <Checkbox
                  ...
                  input-id="agreement"
                  :binary="true"
                  :class="{ 'p-invalid': parentFormErrors.agreement }"
                />                <label
                  for="agreement"
                  class="ml-2 agreement-label"
                >                  Я согласен с                  <a
                ...
                v-if="parentFormErrors.agreement"
                class="p-error"
              >{{ parentFormErrors.agreement }}</small>
            </div>            <div class="field">
              <div class="flex align-items-center">
                <Checkbox
                  v-model="parentForm.rules"
                  input-id="rules"
                  :binary="true"
                  :class="{ 'p-invalid': parentFormErrors.rules }"
                />                <label
                  for="rules"
                  class="ml-2 agreement-label"
                >                  с                  <a
                ...
                v-if="parentFormErrors.rules"
                class="p-error"
              >{{ parentFormErrors.rules }}</small>
            </div>
      ...
      modal
      :show-header="false"
      :style="{ width: '90vw', maxWidth: '650px', height: '90vh', position: 'relative', borderRadius: '6px', }"
      class="privacy-dialog"
    >
      <div style="          display: flex;          position: absolute;          left: 0;          top: 0;          height: 90vh;          width: 100%;          overflow: hidden;          background-color: white;          border-radius: 6px;        ">
        <VuePdfEmbed
          style="width: 100%; position: absolute"
          source="/docs/agreement_user.pdf"
        />        <Button
          style="            position: absolute;            top: 0.5rem;            padding: 1rem;            right: 0.5rem;            width: auto;            height: 5%;          "
          icon="pi pi-times"
