            ...
            <div class="mentor-info">
              <div class="mentor-info-content">
                ...
                <div class="mentor-details">
                  ...
                  <span
                    class="mentor-phone">{{ user?.mobileNumber ? FormatManager.formatMobileNumberFromDTO(user.mobileNumber) : ''
                    }}</span>
                </div>
              </div>
            </div>
    ...
    >
      <div class="delete-confirmation">
        <div class="confirmation-content">
          ...
          <p>Вы уверены, что хотите удалить наставника "{{ selectedMentorToDelete?.name }}" из списка доступных
            наставников?</p>
